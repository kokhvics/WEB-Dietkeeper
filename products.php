                ...
                <div class="row row-cols-1 row-cols-md-3 row-cols-lg-4 g-4">
                    ...
                    try {
                        ...
                        if (isset($_GET['vegetarian'])) {
                            $sql .= " AND category NOT IN ('Мясные продукты', 'Молочные продукты', 'Рыба и морепродукты и морепродукты')";
                        }
                        ...
                        if (isset($_GET['fasting'])) {
                            $sql .= " AND category NOT IN ('Мясные продукты', 'Молочные продукты', 'Рыба и морепродукты и морепродукты', 'Сладости')";
                        }
